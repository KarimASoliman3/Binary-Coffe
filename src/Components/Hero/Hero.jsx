    ...
    <>
      <main style={bgImage}>
        <section className="relative min-h-187.5 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center min-h-212.5">
              ...
              <div className="relative">
                <motion.img
                  ...
                  src={BlackCoffe}
                  alt="BlackCoffe"
                  className="relative z-40 h-100 md:h-175 img-shadow"
                />
                {/* orange circle range*/}
                <motion.div
                  initial={{ opacity: 0, y: 100 }}
          ...
          <div
            className={`absolute top-0 right-0 w-35 h-full bg-linear-to-b from-primary/80 to-primaryDark/80 backdrop-blur-sm z-50 ${openMenu ? "translate-x-0" : "translate-x-full"} transition-transform duration-500`}
          >
            {/* social media icons */}
